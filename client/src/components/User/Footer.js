                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="me-footer-block">
                                    <div className="me-logo">
                                        <a href="/"><img src={brandLogo} alt="logo" style={{ width: "250px", marginTop: "-30px" }} className="img-fluid" /></a>
                                    </div>
                                    <ul>
                                        <li style={{ marginTop: "-30px" }} className="me-footer-emial">accessdeniedbuidl@gmail.com</li>
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="me-footer-block">
                                    <h4>Join Us</h4>
                                    <ul>
                                        <li><a href="/client/donate">Donate Today</a></li>
                                        <li><a href="/auth-artist">Add Your Art</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="me-footer-block">
                                    ...
                                    <ul className="me-footer-share">
                                        <li ><a target="_blank" rel="noreferrer" style={{ fontSize: "25px" }} href="https://github.com/AccessDeniedOrg/BuidlIt2021"><FaGithub /></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="me-copyright-block">
                                    <p>&copy; 2021 copyright all right reserved by <a href="/">GrantéStudio</a></p>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="me-copyright-block">
                                    <ul>
                                        ...
                                        <li><a href="/client">Terms & condition</a></li>
