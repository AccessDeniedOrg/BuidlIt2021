                    ...
                    <>
                        <Form>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                ...
                                <Form.Control value={registerValues['name']} onChange={handleRegisterChange('name')} placeholder="Enter your name" />
                                {errors['nameError'] === "" ? <></> : <div className='error-msg'>{errors['nameError']}</div>}
                            </Form.Group>
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label>Email address</Form.Label>
                                <Form.Control value={registerValues['email']} onChange={handleRegisterChange('email')} type="email" placeholder="Enter your email" />
                                {errors['emailError'] === "" ? <></> : <div className='error-msg'>{errors['emailError']}</div>}
                            </Form.Group>
                            <Form.Group className="mb-3" controlId="formBasicPassword">
                                <Form.Label>Password</Form.Label>
                                <Form.Control value={registerValues['password']} onChange={handleRegisterChange('password')} type="password" placeholder="Enter Password" />
                                {errors['passwordError'] === "" ? <></> : <div className='error-msg'>{errors['passwordError']}</div>}
                            </Form.Group>
                            <Form.Group className="mb-3" controlId="formBasicPassword">
                                <Form.Label>Confirm Password</Form.Label>
                                <Form.Control value={registerValues['confirm_password']} onChange={handleRegisterChange('confirm_password')} type="password" placeholder="Confirm Password" />
                                {errors['matchError'] === "" ? <></> : <div className='error-msg'>{errors['matchError']}</div>}
                            </Form.Group>
                            <button
                                className="me-btn inner-text"
                                type="submit"
            ...
            return (
                <>
                    <Form>
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Label>Email address</Form.Label>
                            <Form.Control type="email" value={loginValues['email']} onChange={handleLoginChange('email')} placeholder="Enter email" />
                            {errors['emailError'] === "" ? <></> : <div className='error-msg'>{errors['emailError']}</div>}
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            <Form.Label>Password</Form.Label>
                            <Form.Control type="password" value={loginValues['password']} onChange={handleLoginChange('password')} placeholder="Password" />
                            {errors['passwordError'] === "" ? <></> : <div className='error-msg'>{errors['passwordError']}</div>}
                        </Form.Group>
                        <div className="text-center">
                            <button
